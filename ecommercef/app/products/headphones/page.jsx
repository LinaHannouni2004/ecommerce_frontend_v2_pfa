...
export default function headphonesPage() {
  ...
  const filteredProducts = headphonesProducts.filter(product => {
      ...
      >
        ...
        <div className="mb-8 text-center">
          <div className="flex items-center text-sm text-gray-400 mb-2 justify-center">
            ...
            <span>headphones&airpods</span>
          </div>
          <h1 className="text-4xl font-bold text-white mb-2 uppercase">headphones&airpods</h1>
        </div>
