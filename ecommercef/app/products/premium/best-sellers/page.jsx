...
export default function BestSellersPage() {
  ...
  const filteredProducts = BestSellersProducts.filter(product => {
      ...
      <div className="premium-content-container">
        <header className="premium-header rounded-xl mb-12 p-8 text-center">
          <div className="breadcrumb justify-center">
            ...
            <span className="breadcrumb-current">BestSellers</span>
          </div>
          <h1 className="premium-title">Our Best Sellers</h1>
          <p className="premium-subtitle">
            Discover our best selling products and get the best deals
          </p>
        </header>
